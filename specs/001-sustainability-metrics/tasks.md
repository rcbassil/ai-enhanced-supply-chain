...
**Input**: Design documents from `.spec/001-sustainability-metrics/`
...
## Phase 4: User Story 3 - Sustainability Metrics via Natural Language Interface (Priority: P3)
...
- [x] T011 [P] Verify solver performance regression is within 10% of pre-change baseline
